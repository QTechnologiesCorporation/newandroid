...
@Composable
fun BusinessRecordsScreen(
    viewModel: BusinessRecordsViewModel = koinViewModel(),
) {
    BusinessRecordsScreenContent()
}

@Composable
fun BusinessRecordsScreenContent() {
...
@Composable
@PreviewLightDark
fun BusinessRecordsScreenContentPreview() {
    QTechHealthTheme {
        BusinessRecordsScreenContent()
    }
}
